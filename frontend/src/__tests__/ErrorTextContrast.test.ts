...
const notesListSrc = readFileSync(join(__dirname, "../app/(shell)/notes/page.tsx"), "utf-8");
const notesDetailSrc = readFileSync(join(__dirname, "../app/(shell)/notes/[bookId]/page.tsx"), "utf-8");
const vocabSrc = readFileSync(join(__dirname, "../app/(shell)/vocabulary/page.tsx"), "utf-8");
